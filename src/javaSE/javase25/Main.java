package javaSE.javase25;

import javaSE.javase25.persion.Exam;
import javaSE.javase25.persion.Person;

/**
 * 面向对象编程实战
 * 虽然我们学习了编程 但是我们不能一股脑的所有问题都照着编程的思维去解决 编程只是解决问题的一种手段 灵活的运用我们所学的知识 才是解决问题的最好办法 比如 求1到100所有的数的和:
 *                  int sum = 0;
